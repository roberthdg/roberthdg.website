...
const workExperience = [
  {year: 'Sep. 2021 - Present', title: 'Front-End Developer', name: 'Synlab Colombia - Bogotá, Colombia (Remote)', description: 'Front-end development (React, Redux).'},
  {year: 'May. 2020 - Sep. 2021', title: 'Full-Stack Developer', name: 'Bees2Biz - Bogotá, Colombia (Remote)', description: 'Front-end development (React, Angular, Vue.js), database design (MySQL), API development (Django REST framework).'},
  ...
  {year: 'Oct. 2014 - Mar. 2016', title: 'IT Analyst', name: 'Productora y Distribuidora Venezolana de Alimentos S.A. - Nueva Esparta, Venezuela', description: 'Web app development (PHP, JavaScript, CSS and MySQL), staff training on proprietary software, IT support.'}
