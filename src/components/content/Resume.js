...
const workExperience = [
  {year: 'Apr. 2020 - June 2020', title: 'Full-Stack Developer', name: 'Bees2Biz - Bogotá, Colombia (Remote)', description: 'Front-end development (VueJS), database design (MySQL), API development (Django REST framework).'},
