...
const workExperience = [
  {year: 'Apr. 2020 - Present', title: 'Full-Stack Developer', name: 'Bees2Biz - Bogotá, Colombia (Remote)', description: 'Front-end development (VueJS), database design (MySQL), API development (Django REST framework).'},
